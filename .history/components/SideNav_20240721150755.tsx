...
const SideNav: React.FC = () => {
  ...
  return (
    <>
      ...
      <nav className={`fixed top-0 left-0 h-full z-50 transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 bg-gradient-to-b from-transparent via-transparent to-transparent`} style={{ boxShadow: "0 10px 30px rgba(0, 0, 0, 0.1)" }}>
        <div className={`flex flex-col items-center justify-between h-full py-7 px-4 transition-all duration-300 ease-in-out ${isCollapsed ? 'w-20 bg-[radial-gradient(circle,_#432C2C20_0%,_#501C1C00_100%)]' : 'w-64 bg-[radial-gradient(circle,_#432C2C20_0%,_#501C1C00_100%)]'}`}>
