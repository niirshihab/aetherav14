...
export const SideNav: React.FC = () => {
  ...
  return (
    <nav className="flex flex-col items-center justify-between h-full py-7 px-4 rounded-xl w-full max-w-[256px]" style={{ background: "radial-gradient(circle, #432C2C20 0%, #501C1C00 100%)", boxShadow: "0 10px 30px rgba(0, 0, 0, 0.1)" }}>
