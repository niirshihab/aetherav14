            ...
            <div className="relative">
              ...
              >
                <div className="MaskGroup w-12 h-12 relative">
                  <img className="TopBarProfileDropdown w-12 h-12 left-0 top-0 absolute rounded-full" src="public/collaborator1.png" alt="Profile" />
                </div>
              </button>
              {isDropdownOpen && (
                  ...
                  <div className="Sidebar h-44 flex-col justify-start items-center gap-0.5 flex">
                    <div className="Avatars h-14 px-8 py-5 justify-center items-center gap-2.5 inline-flex">
                      <div className="MaskGroup w-11 h-11 relative">
                        <img className="Ellipse1 w-11 h-11 left-0 top-0 absolute rounded-full" src="public/collaborator1.png" alt="Profile" />
                      </div>
