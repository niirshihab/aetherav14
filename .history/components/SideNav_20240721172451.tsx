...
const navItems = [
  ...
  { name: 'Taskaty', href: '/taskaty', icon: '/icons/tablericonlistdetails.svg', dropdown: true },
  { name: 'BrodBank', href: '/brodbank', icon: '/icons/tablericonsquareasterisk.svg' },
  { name: 'BrodGPT', href: '/brodgpt', icon: '/icons/tablericonbrandopenai.svg' },
  { name: 'Salam', href: '/salam', icon: '/icons/tablericonbrandcashapp.svg', dropdown: true },
  { name: 'Oops Moments', href: '/oops-moments', icon: '/icons/tablericonmoodsmilebeam.svg' },
  { name: 'Mental Workout', href: '/mental-workout', icon: '/icons/tablericonstretching.svg' },
  { name: 'MOM', href: '/mom', icon: '/icons/tablericonbrandfinder.svg' },
  { name: 'B Points', href: '/b-points', icon: '/icons/tablericonnumber.svg' },
]
