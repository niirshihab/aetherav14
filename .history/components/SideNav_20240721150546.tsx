...
const SideNav: React.FC = () => {
  ...
  return (
    <>
      ...
      <nav className={`fixed top-0 left-0 h-full z-50 transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 ${isCollapsed ? 'w-20' : 'w-64'}`} style={{ background: "radial-gradient(circle, #432C2C20 0%, #501C1C00 100%)", boxShadow: "0 10px 30px rgba(0, 0, 0, 0.1)" }}>
