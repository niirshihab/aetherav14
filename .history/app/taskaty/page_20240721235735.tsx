...
export default function TaskatyPage() {
  ...
  const fetchTasks = async () => {
    ...
    try {
      ...
      setToastMessage({ message: 'Failed to fetch tasks', type: 'error' })
    } finally {
      setIsLoading(false)
    }
  }
  ...
  const handleEditSave = async () => {
    ...
    try {
      ...
      setEditingTask(null)
      setEditedTask(null)
      setToastMessage({ message: 'Task updated successfully', type: 'success' })
    } catch (err) {
      console.error('Error updating task:', err)
      setToastMessage({ message: 'Failed to update task', type: 'error' })
    } finally {
      setIsSaving(false)
    }
  }
